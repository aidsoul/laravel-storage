...
function brackets(string $field)
{
    return '(' . $field . ')';
}
...
return [
    ...
    */
    ...
    'custom' => [
        'firstname' => [
            'regex' => 'Поле :attribute должно содержать только кириллицу.'
        ],
        'lastname' => [
            'regex' => 'Поле :attribute должно содержать только кириллицу.'
        ],
        'password' => [
            'regex' => 'Поле :attribute должно содержать хотя бы одно: число, спецсимвол, латинскую букву в нижнем и в верхнем регистре.'
        ],
        'email' => [
            'regex' => 'Поле :attribute должно соответствовать паттерну почты: example@mail.com'
        ],
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        'storage_size' => brackets('Размер диска'),
        'email' => brackets('Email'),
        'password' => brackets('Пароль'),
        'password_confirmation' => brackets('Повторите пароль'),
        'firstname' => brackets('Имя'),
        'lastname' => brackets('Фамилия'),
        'role' => brackets('Роль'),
        'blocked' => brackets('Блокировка профиля'),
        'fileUpload' => brackets('Загрузка файла'),
        'fileName' => brackets('Имя файла'),
        'folderName'=>brackets('Имя папки')
    ],
